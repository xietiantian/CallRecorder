package bupt.tiantian.callrecorder.listeners;
...
import bupt.tiantian.callrecorder.receivers.MyCallReceiver;
import bupt.tiantian.callrecorder.services.RecordCallService;
    ...
    public void onCallStateChanged(int state, String incomingNumber) {
        ...
        switch (state) {
            case TelephonyManager.CALL_STATE_IDLE: // Idle... no call
                if (isRecording.get()) {
                    RecordCallService.stopRecordingService(context);
                    phoneCall = null;
            ...
            case TelephonyManager.CALL_STATE_OFFHOOK: // Call answered
                ...
                if (!isRecording.get()) {
                    ...
                    RecordCallService.startRecordingService(context, phoneCall);
                }
                break;
