...
public class MainActivity extends AppCompatActivity
        implements RecordingFragment.OnListFragmentInteractionListener,
...
//        RateMeNowDialog.showRateDialog(this, 10);
                    ...
                    public void run() {
                        ...
                        LocalBroadcastManager.getInstance(MainActivity.this)
                                .sendBroadcast(new Intent(
                                        LocalBroadcastActions.NEW_RECORDING_BROADCAST)); // Causes refresh
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Runnable runnable = new Runnable() {
                            ...
                            public void run() {
                                ...
                                LocalBroadcastManager.getInstance(MainActivity.this)
                                        .sendBroadcast(new Intent(
                                                LocalBroadcastActions.RECORDING_DELETED_BROADCAST));
        ...
        if (!permissionReadContacts)
            if (ActivityCompat.checkSelfPermission(this, Manifest.permission.READ_CONTACTS) != PackageManager.PERMISSION_GRANTED) {
                ...
                if (ActivityCompat.shouldShowRequestPermissionRationale(this,
                    ...
                    new android.app.AlertDialog.Builder(this).setCancelable(true)
                            .setMessage(R.string.str_access_permissions)
        ...
        if (!permissionWriteExternal)
            if (ActivityCompat.checkSelfPermission(this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                ...
                if (ActivityCompat.shouldShowRequestPermissionRationale(this,
                    ...
                    // sees the explanation, try again to request the permission.
                    new android.app.AlertDialog.Builder(this).setCancelable(true)
                            .setMessage(R.string.str_write_external_permission)
                            .setPositiveButton(R.string.dialog_ok, new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialog, int which) {
                                    ActivityCompat.requestPermissions(MainActivity.this,
    ...
    public void onRequestPermissionsResult(int requestCode, String permissions[], int[] grantResults) {
        switch (requestCode) {
            ...
            case 0x02: {  // validateRequestPermissionsRequestCode in FragmentActivity requires requestCode to be of 8 bits, meaning the range is from 0 to 255.
                // If request is cancelled, the result arrays are empty.
                if (grantResults.length > 0) { // we only asked for one permission
